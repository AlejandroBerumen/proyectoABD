...
import static proyectofinalb.ProyectoFinalB.vp;
...
public class EditarUsuario extends javax.swing.JInternalFrame {
    ...
    public EditarUsuario() {
        ...
        txtNombre.addKeyListener(mg.noEspaciosNiCaracteresRaros); txtId.addKeyListener(mg.soloNumeros);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese la ID del usuario que desea editar:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(109, 109, 109)
                                .addComponent(cbPrivilegios, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        txtNombre.setEditable(false);
        cbPrivilegios.setEnabled(false);
        cbPrivilegios.setSelectedItem("Administrador");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(txtNombre.getText().length()<4)
            JOptionPane.showMessageDialog(null,"La longitud del nombre no es válida.");
        else{
            String privs = "";
            if(cbPrivilegios.getSelectedItem().toString().equals("Administrador"))
                privs = "1"; else privs = "0";
            cbd.editarRegistro("usuario", "nombre='"+txtNombre.getText()+"', admin='"+privs+"'", "id_usuario="+txtId.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(txtId.getText().equals(""))
            ...
            if(cbd.obtenerRegistros("usuario", "id_usuario="+txtId.getText())[0][3].equals("0"))
                cbPrivilegios.setSelectedItem("Usuario");
            else
                cbPrivilegios.setSelectedItem("Administrador");
        }
